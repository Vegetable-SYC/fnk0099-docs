...
.. image:: ../_static/imgs/5_WiFi_Working_Modes/Chapter05_00.png
    :align: center
...
Open "Thonny", click "This computer" -> "D:" -> "Micropython_Codes" -> "05.1_Station_mode" and double click "Station_mode.py". 

05.1_Station_mode
---------------------------------

.. image:: ../_static/imgs/5_WiFi_Working_Modes/Chapter05_10.png
    :align: center
...
.. image:: ../_static/imgs/5_WiFi_Working_Modes/Chapter05_11.png
    :align: center

The following is the program code:

.. literalinclude:: ../../../freenove_Kit/Python/Python_Codes/05.1_Station_mode/Station_mode.py
    :linenos: 
    :language: python
    :lines: 1-22
    :dedent:
...
.. image:: ../_static/imgs/5_WiFi_Working_Modes/Chapter05_03.png
    :align: center
...
Open "Thonny", click "This computer" -> "D:" -> "Micropython_Codes" -> "05.2_AP_mode". and double click "AP_mode.py". 

05.2_AP_mode
----------------------------

.. image:: ../_static/imgs/5_WiFi_Working_Modes/Chapter05_12.png
    :align: center
...
.. image:: ../_static/imgs/5_WiFi_Working_Modes/Chapter05_13.png
    :align: center
...
.. image:: ../_static/imgs/5_WiFi_Working_Modes/Chapter05_14.png
    :align: center

The following is the program code:

.. literalinclude:: ../../../freenove_Kit/Python/Python_Codes/05.2_AP_mode/AP_mode.py
    :linenos: 
    :language: python
    :lines: 1-25
    :dedent:
...
Open "Thonny", click "This computer" -> "D:" -> "Micropython_Codes" -> "05.3_AP+STA_mode"and double click "AP+STA_mode.py". 

05.3_AP+STA_mode
--------------------------------

.. image:: ../_static/imgs/5_WiFi_Working_Modes/Chapter05_15.png
    :align: center
...
.. image:: ../_static/imgs/5_WiFi_Working_Modes/Chapter05_16.png
    :align: center

Turn on the WiFi scanning function of your phone, and you can see the ssidAP on ESP32-S3.

.. image:: ../_static/imgs/5_WiFi_Working_Modes/Chapter05_17.png
    :align: center

The following is the program code:

.. literalinclude:: ../../../freenove_Kit/Python/Python_Codes/05.3_AP+STA_mode/AP+STA_mode.py
    :linenos: 
    :language: python
    :lines: 1-99
    :dedent: